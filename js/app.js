...
const I18N = {
  en: {
    ...
    qaBtn: 'Quick Add', contactBtn: 'Contact Us',
    ...
    newsText: 'New arrivals reach our list first — before they hit the site. Unsubscribe anytime.',
    newsPh: 'Your email', newsBtn: 'Subscribe', newsOk: 'You\'re on the list. First look comes to you.',
  ...
  zh: {
    ...
    heroLead: '没有中间商，没有品牌溢价。自己纺纱、自己织造、自己发货——该是多少钱，就标多少钱。',
    ...
    newsTitle: '上新通知',
    newsTitle2: '先到先穿。',
    newsText: '新品上架前，先发到你的邮箱。随时可退订。',
    newsPh: '你的邮箱', newsBtn: '订阅', newsOk: '记下了，下次新品先到你这。',
    footerTag: '自有织厂直出的羊毛针织。原料、织造、发货，全程自己来。',
    footShop: '逛逛', footContact: '联系', footFollow: '关注', footCopy: '© 2026 FanFlo 繁花毛织 · 样板站', footSlogan: '诚实的面料，诚实的价钱。',
    ...
    cTitle: '购物车', cEmptyBig: '购物车还是空的', cEmptyText: '去挑一件好的羊毛衫吧。', cEmptyBtn: '去逛逛',
